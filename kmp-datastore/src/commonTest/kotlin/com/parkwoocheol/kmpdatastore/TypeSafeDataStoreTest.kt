...
class TypeSafeDataStoreTest {
    ...
    @Test
    fun `putInt and getInt should store and retrieve integer`() =
        runTest {
    ...
    @Test
    fun `getInt should return null for non-existent key`() =
        runTest {
    ...
    @Test
    fun `putInt should update existing value`() =
        runTest {
            testPreferences.putInt("test_key", 42)
    ...
    @Test
    fun `putLong and getLong should store and retrieve long`() =
        runTest {
    ...
    @Test
    fun `putFloat and getFloat should store and retrieve float`() =
        runTest {
    ...
    @Test
    fun `putDouble and getDouble should store and retrieve double`() =
        runTest {
    ...
    @Test
    fun `putBoolean and getBoolean should store and retrieve boolean`() =
        runTest {
    ...
    @Test
    fun `putBoolean should handle false value`() =
        runTest {
    ...
    @Test
    fun `putString and getString should store and retrieve string`() =
        runTest {
    ...
    @Test
    fun `putString should handle empty string`() =
        runTest {
    ...
    @Test
    fun `putString should handle unicode characters`() =
        runTest {
    ...
    @Test
    fun `putStringSet and getStringSet should store and retrieve set`() =
        runTest {
    ...
    @Test
    fun `putStringSet should handle empty set`() =
        runTest {
    ...
    @Test
    fun `MockSerializer should encode and decode simple object`() =
        runTest {
    ...
    @Test
    fun `MockSerializer should handle complex nested objects`() =
        runTest {
            val data =
                ComplexData(
                    id = 123,
    ...
    @Test
    fun `MockSerializer clearHistory should clear tracking`() =
        runTest {
    ...
    @Test
    fun `remove should delete key-value pair`() =
        runTest {
    ...
    @Test
    fun `remove should be idempotent for non-existent key`() =
        runTest {
            // Should not throw
    ...
    @Test
    fun `clear should be idempotent on empty store`() =
        runTest {
            testPreferences.clear()
    ...
    @Test
    fun `getAllKeys should return all stored keys`() =
        runTest {
            testPreferences.putString("key1", "value1")
            testPreferences.putInt("key2", 42)
            testPreferences.putBoolean("key3", true)
    ...
    @Test
    fun `getAllKeys should return empty set for empty store`() =
        runTest {
            val keys = testPreferences.getAllKeys().first()
            assertTrue(keys.isEmpty())
        }
    ...
    @Test
    fun `getAllKeys should update when keys are added or removed`() =
        runTest {
            testPreferences.putString("key1", "value1")
    ...
    @Test
    fun `TestPreferencesDataStore should maintain data integrity across operations`() =
        runTest {
    ...
    @Test
    fun `TestPreferencesDataStore getSnapshot should return current state`() =
        runTest {
