...
class DataStoreQueryTest {
    ...
    @Test
    fun `select should match exact pattern`() =
        runTest {
    ...
    @Test
    fun `select should match wildcard at end`() =
        runTest {
            testPreferences.putString("user_name", "Alice")
            testPreferences.putString("user_age", "25")
    ...
    @Test
    fun `select should match wildcard at start`() =
        runTest {
            testPreferences.putString("user_name", "Alice")
    ...
    @Test
    fun `select should match wildcard in middle`() =
        runTest {
    ...
    @Test
    fun `select should match exact string without wildcard`() =
        runTest {
    ...
    @Test
    fun `select should return empty for no matches`() =
        runTest {
            testPreferences.putString("user_name", "Alice")
            testPreferences.putString("user_age", "25")
    ...
    @Test
    fun `keysStartingWith should filter keys by prefix`() =
        runTest {
            testPreferences.putString("user_name", "Alice")
            testPreferences.putString("user_age", "25")
            testPreferences.putString("app_theme", "dark")
    ...
    @Test
    fun `keysEndingWith should filter keys by suffix`() =
        runTest {
            testPreferences.putString("user_name", "Alice")
            testPreferences.putString("admin_name", "Bob")
            testPreferences.putString("user_age", "25")
    ...
    @Test
    fun `keysContaining should filter keys by substring`() =
        runTest {
            testPreferences.putString("user_profile_name", "Alice")
    ...
    @Test
    fun `count should return total number of keys`() =
        runTest {
    ...
    @Test
    fun `count should return 0 for empty store`() =
        runTest {
            val count = testPreferences.getAllKeys().first().size
    ...
    @Test
    fun `count with pattern should return matching count`() =
        runTest {
            testPreferences.putString("user_name", "Alice")
            testPreferences.putString("user_age", "25")
            testPreferences.putString("app_theme", "dark")
    ...
    @Test
    fun `containsKey should return true for existing key`() =
        runTest {
    ...
    @Test
    fun `containsKey should return false for non-existent key`() =
        runTest {
            val keys = testPreferences.getAllKeys().first()
