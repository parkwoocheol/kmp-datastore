...
class DataStoreValueQueryTest {
    ...
    @Test
    fun `filterByValue should filter by predicate`() =
        runTest {
    ...
    @Test
    fun `valueEquals should match specific value`() =
        runTest {
    ...
    @Test
    fun `valueBetween should filter numeric range`() =
        runTest {
    ...
    @Test
    fun `valueContains should match substring`() =
        runTest {
    ...
    @Test
    fun `sortByValueAscending should sort numeric values`() =
        runTest {
    ...
    @Test
    fun `sortByValueDescending should sort in reverse`() =
        runTest {
            testPreferences.putInt("num_1", 10)
            testPreferences.putInt("num_2", 20)
            testPreferences.putInt("num_3", 30)
    ...
    @Test
    fun `sortByValueAscending should sort string values`() =
        runTest {
    ...
    @Test
    fun `chained filters should work together`() =
        runTest {
            testPreferences.putInt("age_alice", 25)
            testPreferences.putInt("age_bob", 30)
            testPreferences.putInt("age_charlie", 35)
    ...
    @Test
    fun `filter and sort should work together`() =
        runTest {
            testPreferences.putInt("score_1", 50)
            testPreferences.putInt("score_2", 75)
            testPreferences.putInt("score_3", 90)
    ...
    @Test
    fun `skip should offset results`() =
        runTest {
            testPreferences.putInt("item_1", 1)
            testPreferences.putInt("item_2", 2)
            testPreferences.putInt("item_3", 3)
    ...
    @Test
    fun `take and skip together should paginate`() =
        runTest {
            testPreferences.putInt("item_1", 1)
            testPreferences.putInt("item_2", 2)
            testPreferences.putInt("item_3", 3)
    ...
    @Test
    fun `empty result set should be handled`() =
        runTest {
            testPreferences.putInt("num_1", 10)
            testPreferences.putInt("num_2", 20)
    ...
    @Test
    fun `single result should be handled`() =
        runTest {
